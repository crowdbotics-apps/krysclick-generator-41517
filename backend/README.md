...
## Project Structure
    ...
    ├── krysclick_generator_41517  # Django project configurations
...
1. Clone this repo and `cd krysclick_generator_41517`
...
2. Clone this repo and `cd krysclick_generator_41517`
